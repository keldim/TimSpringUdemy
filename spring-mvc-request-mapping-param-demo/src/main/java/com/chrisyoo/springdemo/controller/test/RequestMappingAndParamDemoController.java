package com.chrisyoo.springdemo.controller.test;
...
public class RequestMappingAndParamDemoController {
	...
	// test 1: Testing @RequestParam without explicit attribtes
	...
	// test 6, subtest 4: Testing with multiple request params and @RequestParam with a single param
		...
		// test 7 & 8: Testing @RequestParam with multiple request URIs
