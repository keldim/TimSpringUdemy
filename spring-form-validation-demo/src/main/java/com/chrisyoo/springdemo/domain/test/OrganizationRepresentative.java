...
import com.chrisyoo.springdemo.validation.test.AgeConstraint;
import com.chrisyoo.springdemo.validation.test.EmailVerification;
import com.chrisyoo.springdemo.validation.test.FieldsVerification;
...
public class OrganizationRepresentative {
	...
	@Size(min=3, max=10, message="* Suranme: min 3 characters required, max 10 characters allowed")
